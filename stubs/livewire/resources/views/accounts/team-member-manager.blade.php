<div>
    ...
    <x-jet-confirmation-modal wire:model="confirmingLeavingAccount">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ml-2" wire:click="leaveAccount" wire:loading.attr="disabled">
                {{ __('Leave') }}
            </x-jet-danger-button>
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingAccountMemberRemoval">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ml-2" wire:click="removeAccountMember" wire:loading.attr="disabled">
                {{ __('Remove') }}
            </x-jet-danger-button>
        </x-slot>
    </x-jet-confirmation-modal>
